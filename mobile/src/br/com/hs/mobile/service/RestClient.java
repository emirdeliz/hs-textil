...
public class RestClient {
	...
	public void callWebService(int method) throws IllegalStateException, ClientProtocolException, IOException {
		...
		case GET:
			...
			System.out.println(url + buildParams());
			...
			while (it.hasNext()) {
				Entry header = it.next();
				request.addHeader(header.getKey().toString().toString(), header.getValue().toString());
			}
	...
	public JSONArray createObjectJson() throws JSONException{		
